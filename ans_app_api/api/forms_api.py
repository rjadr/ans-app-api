...
class FormsApi(object):
    ...
    def api_v2_assignments_assignment_id_forms_delete(self, assignment_id, **kwargs):  # noqa: E501
        """Delete forms  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.api_v2_assignments_assignment_id_forms_delete(assignment_id, async_req=True)
        >>> result = thread.get()
        ...
        if kwargs.get('async_req'):
            return self.api_v2_assignments_assignment_id_forms_delete_with_http_info(assignment_id, **kwargs)  # noqa: E501
        else:
            (data) = self.api_v2_assignments_assignment_id_forms_delete_with_http_info(assignment_id, **kwargs)  # noqa: E501
            return data

    def api_v2_assignments_assignment_id_forms_delete_with_http_info(self, assignment_id, **kwargs):  # noqa: E501
        """Delete forms  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.api_v2_assignments_assignment_id_forms_delete_with_http_info(assignment_id, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    ...
                    " to method api_v2_assignments_assignment_id_forms_delete" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        if ('assignment_id' not in params or
            ...
            raise ValueError("Missing the required parameter `assignment_id` when calling `api_v2_assignments_assignment_id_forms_delete`")  # noqa: E501
        ...
        return self.api_client.call_api(
            '/api/v2/assignments/{assignment_id}/forms', 'DELETE',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def api_v2_assignments_assignment_id_forms_get(self, assignment_id, **kwargs):  # noqa: E501
        """List forms  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.api_v2_assignments_assignment_id_forms_get(assignment_id, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.api_v2_assignments_assignment_id_forms_get_with_http_info(assignment_id, **kwargs)  # noqa: E501
        else:
            (data) = self.api_v2_assignments_assignment_id_forms_get_with_http_info(assignment_id, **kwargs)  # noqa: E501
            return data

    def api_v2_assignments_assignment_id_forms_get_with_http_info(self, assignment_id, **kwargs):  # noqa: E501
        """List forms  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.api_v2_assignments_assignment_id_forms_get_with_http_info(assignment_id, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api_v2_assignments_assignment_id_forms_get" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'assignment_id' is set
        if ('assignment_id' not in params or
                params['assignment_id'] is None):
            raise ValueError("Missing the required parameter `assignment_id` when calling `api_v2_assignments_assignment_id_forms_get`")  # noqa: E501
        ...
        return self.api_client.call_api(
            '/api/v2/assignments/{assignment_id}/forms', 'GET',
            path_params,
            query_params,
            header_params,
            body=body_params,
