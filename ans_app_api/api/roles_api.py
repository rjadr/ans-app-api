...
class RolesApi(object):
    ...
    def api_v2_schools_school_id_roles_get(self, school_id, **kwargs):  # noqa: E501
        """List roles  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.api_v2_schools_school_id_roles_get(school_id, async_req=True)
        >>> result = thread.get()
        ...
        if kwargs.get('async_req'):
            return self.api_v2_schools_school_id_roles_get_with_http_info(school_id, **kwargs)  # noqa: E501
        else:
            (data) = self.api_v2_schools_school_id_roles_get_with_http_info(school_id, **kwargs)  # noqa: E501
            return data

    def api_v2_schools_school_id_roles_get_with_http_info(self, school_id, **kwargs):  # noqa: E501
        """List roles  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.api_v2_schools_school_id_roles_get_with_http_info(school_id, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    ...
                    " to method api_v2_schools_school_id_roles_get" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        if ('school_id' not in params or
            ...
            raise ValueError("Missing the required parameter `school_id` when calling `api_v2_schools_school_id_roles_get`")  # noqa: E501
        ...
        return self.api_client.call_api(
            '/api/v2/schools/{school_id}/roles', 'GET',
            path_params,
            query_params,
            header_params,
            body=body_params,
