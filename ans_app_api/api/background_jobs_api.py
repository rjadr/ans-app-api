...
class BackgroundJobsApi(object):
    ...
    def api_v2_background_jobs_get(self, **kwargs):  # noqa: E501
        """List background jobs  # noqa: E501
        ...
        if kwargs.get('async_req'):
            return self.api_v2_background_jobs_get_with_http_info(**kwargs)  # noqa: E501
        else:
            (data) = self.api_v2_background_jobs_get_with_http_info(**kwargs)  # noqa: E501
            return data

    def api_v2_background_jobs_get_with_http_info(self, **kwargs):  # noqa: E501
        """List background jobs  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.api_v2_background_jobs_get_with_http_info(async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    ...
                    " to method api_v2_background_jobs_get" % key
                )
            params[key] = val
        del params['kwargs']
    ...
    def api_v2_background_jobs_id_get(self, id, **kwargs):  # noqa: E501
        """Show background job  # noqa: E501
        ...
        if kwargs.get('async_req'):
            ...
            (data) = self.api_v2_background_jobs_id_get_with_http_info(id, **kwargs)  # noqa: E501
            return data

    def api_v2_background_jobs_id_get_with_http_info(self, id, **kwargs):  # noqa: E501
        """Show background job  # noqa: E501
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api_v2_background_jobs_id_get" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        if ('id' not in params or
                params['id'] is None):
            raise ValueError("Missing the required parameter `id` when calling `api_v2_background_jobs_id_get`")  # noqa: E501
    ...
    def api_v2_background_jobs_id_patch(self, id, **kwargs):  # noqa: E501
        """Update background job  # noqa: E501

        To start the processing of an initialized background job after you uploaded the file, you must update the status to \"pending\". You can only update background jobs you created yourself and that currently have the \"initialized\" status.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.api_v2_background_jobs_id_patch(id, async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param str id: id (required)
        :param BackgroundJobsIdBody body:
        :return: None
                 If the method is called asynchronously,
                 returns the request thread.
        """
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.api_v2_background_jobs_id_patch_with_http_info(id, **kwargs)  # noqa: E501
        else:
            (data) = self.api_v2_background_jobs_id_patch_with_http_info(id, **kwargs)  # noqa: E501
            return data

    def api_v2_background_jobs_id_patch_with_http_info(self, id, **kwargs):  # noqa: E501
        """Update background job  # noqa: E501

        To start the processing of an initialized background job after you uploaded the file, you must update the status to \"pending\". You can only update background jobs you created yourself and that currently have the \"initialized\" status.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.api_v2_background_jobs_id_patch_with_http_info(id, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api_v2_background_jobs_id_patch" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'id' is set
        if ('id' not in params or
                params['id'] is None):
            raise ValueError("Missing the required parameter `id` when calling `api_v2_background_jobs_id_patch`")  # noqa: E501
        ...
        return self.api_client.call_api(
            '/api/v2/background_jobs/{id}', 'PATCH',
            path_params,
            query_params,
            header_params,
            body=body_params,
