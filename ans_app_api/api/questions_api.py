...
class QuestionsApi(object):
    ...
    def api_v2_exercises_exercise_id_questions_get(self, exercise_id, **kwargs):  # noqa: E501
        """List questions  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.api_v2_exercises_exercise_id_questions_get(exercise_id, async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param str exercise_id: exercise_id (required)
        ...
        if kwargs.get('async_req'):
            return self.api_v2_exercises_exercise_id_questions_get_with_http_info(exercise_id, **kwargs)  # noqa: E501
        else:
            (data) = self.api_v2_exercises_exercise_id_questions_get_with_http_info(exercise_id, **kwargs)  # noqa: E501
            return data

    def api_v2_exercises_exercise_id_questions_get_with_http_info(self, exercise_id, **kwargs):  # noqa: E501
        """List questions  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.api_v2_exercises_exercise_id_questions_get_with_http_info(exercise_id, async_req=True)
        >>> result = thread.get()
        ...
        all_params = ['exercise_id', 'items', 'page']  # noqa: E501
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    ...
                    " to method api_v2_exercises_exercise_id_questions_get" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        if ('exercise_id' not in params or
            ...
            raise ValueError("Missing the required parameter `exercise_id` when calling `api_v2_exercises_exercise_id_questions_get`")  # noqa: E501

        collection_formats = {}

        path_params = {}
        if 'exercise_id' in params:
            path_params['exercise_id'] = params['exercise_id']  # noqa: E501
        ...
        return self.api_client.call_api(
            '/api/v2/exercises/{exercise_id}/questions', 'GET',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def api_v2_exercises_exercise_id_questions_post(self, exercise_id, **kwargs):  # noqa: E501
        """Create question  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.api_v2_exercises_exercise_id_questions_post(exercise_id, async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param str exercise_id: exercise_id (required)
        :param ExerciseIdQuestionsBody body:
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.api_v2_exercises_exercise_id_questions_post_with_http_info(exercise_id, **kwargs)  # noqa: E501
        else:
            (data) = self.api_v2_exercises_exercise_id_questions_post_with_http_info(exercise_id, **kwargs)  # noqa: E501
            return data

    def api_v2_exercises_exercise_id_questions_post_with_http_info(self, exercise_id, **kwargs):  # noqa: E501
        """Create question  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.api_v2_exercises_exercise_id_questions_post_with_http_info(exercise_id, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api_v2_exercises_exercise_id_questions_post" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'exercise_id' is set
        if ('exercise_id' not in params or
                params['exercise_id'] is None):
            raise ValueError("Missing the required parameter `exercise_id` when calling `api_v2_exercises_exercise_id_questions_post`")  # noqa: E501
        ...
        return self.api_client.call_api(
            '/api/v2/exercises/{exercise_id}/questions', 'POST',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def api_v2_questions_id_delete(self, id, **kwargs):  # noqa: E501
        """Delete question  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.api_v2_questions_id_delete(id, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.api_v2_questions_id_delete_with_http_info(id, **kwargs)  # noqa: E501
        else:
            (data) = self.api_v2_questions_id_delete_with_http_info(id, **kwargs)  # noqa: E501
            return data

    def api_v2_questions_id_delete_with_http_info(self, id, **kwargs):  # noqa: E501
        """Delete question  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.api_v2_questions_id_delete_with_http_info(id, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api_v2_questions_id_delete" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        if ('id' not in params or
                params['id'] is None):
            raise ValueError("Missing the required parameter `id` when calling `api_v2_questions_id_delete`")  # noqa: E501
    ...
    def api_v2_questions_id_get(self, id, **kwargs):  # noqa: E501
        """Show question  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.api_v2_questions_id_get(id, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.api_v2_questions_id_get_with_http_info(id, **kwargs)  # noqa: E501
        else:
            (data) = self.api_v2_questions_id_get_with_http_info(id, **kwargs)  # noqa: E501
            return data

    def api_v2_questions_id_get_with_http_info(self, id, **kwargs):  # noqa: E501
        """Show question  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.api_v2_questions_id_get_with_http_info(id, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api_v2_questions_id_get" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'id' is set
        if ('id' not in params or
                params['id'] is None):
            raise ValueError("Missing the required parameter `id` when calling `api_v2_questions_id_get`")  # noqa: E501
    ...
    def api_v2_questions_id_patch(self, id, **kwargs):  # noqa: E501
        """Update question  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.api_v2_questions_id_patch(id, async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param str id: id (required)
        :param QuestionsIdBody body:
        :return: InlineResponse2016
                 If the method is called asynchronously,
                 returns the request thread.
        """
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.api_v2_questions_id_patch_with_http_info(id, **kwargs)  # noqa: E501
        else:
            (data) = self.api_v2_questions_id_patch_with_http_info(id, **kwargs)  # noqa: E501
            return data

    def api_v2_questions_id_patch_with_http_info(self, id, **kwargs):  # noqa: E501
        """Update question  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.api_v2_questions_id_patch_with_http_info(id, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api_v2_questions_id_patch" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'id' is set
        if ('id' not in params or
                params['id'] is None):
            raise ValueError("Missing the required parameter `id` when calling `api_v2_questions_id_patch`")  # noqa: E501
