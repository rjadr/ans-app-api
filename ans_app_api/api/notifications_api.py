...
class NotificationsApi(object):
    ...
    def api_v2_notifications_get(self, **kwargs):  # noqa: E501
        """List notifications  # noqa: E501

        List all your notifications  # noqa: E501
        ...
        if kwargs.get('async_req'):
            return self.api_v2_notifications_get_with_http_info(**kwargs)  # noqa: E501
        else:
            (data) = self.api_v2_notifications_get_with_http_info(**kwargs)  # noqa: E501
            return data

    def api_v2_notifications_get_with_http_info(self, **kwargs):  # noqa: E501
        """List notifications  # noqa: E501

        List all your notifications  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.api_v2_notifications_get_with_http_info(async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    ...
                    " to method api_v2_notifications_get" % key
                )
            params[key] = val
        del params['kwargs']
    ...
    def api_v2_notifications_id_get(self, id, **kwargs):  # noqa: E501
        """Show notification  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.api_v2_notifications_id_get(id, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.api_v2_notifications_id_get_with_http_info(id, **kwargs)  # noqa: E501
        else:
            (data) = self.api_v2_notifications_id_get_with_http_info(id, **kwargs)  # noqa: E501
            return data

    def api_v2_notifications_id_get_with_http_info(self, id, **kwargs):  # noqa: E501
        """Show notification  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.api_v2_notifications_id_get_with_http_info(id, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api_v2_notifications_id_get" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        if ('id' not in params or
                params['id'] is None):
            raise ValueError("Missing the required parameter `id` when calling `api_v2_notifications_id_get`")  # noqa: E501
