...
class QuestionBanksApi(object):
    ...
    def api_v2_question_banks_get(self, **kwargs):  # noqa: E501
        """List question banks  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.api_v2_question_banks_get(async_req=True)
        >>> result = thread.get()
        ...
        if kwargs.get('async_req'):
            return self.api_v2_question_banks_get_with_http_info(**kwargs)  # noqa: E501
        else:
            (data) = self.api_v2_question_banks_get_with_http_info(**kwargs)  # noqa: E501
            return data

    def api_v2_question_banks_get_with_http_info(self, **kwargs):  # noqa: E501
        """List question banks  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.api_v2_question_banks_get_with_http_info(async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    ...
                    " to method api_v2_question_banks_get" % key
                )
            params[key] = val
        del params['kwargs']
    ...
    def api_v2_question_banks_id_delete(self, id, **kwargs):  # noqa: E501
        """Delete question bank  # noqa: E501

        Soft delete a question bank by moving it to removed question banks  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.api_v2_question_banks_id_delete(id, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.api_v2_question_banks_id_delete_with_http_info(id, **kwargs)  # noqa: E501
        else:
            (data) = self.api_v2_question_banks_id_delete_with_http_info(id, **kwargs)  # noqa: E501
            return data

    def api_v2_question_banks_id_delete_with_http_info(self, id, **kwargs):  # noqa: E501
        """Delete question bank  # noqa: E501

        Soft delete a question bank by moving it to removed question banks  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.api_v2_question_banks_id_delete_with_http_info(id, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api_v2_question_banks_id_delete" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        if ('id' not in params or
                params['id'] is None):
            raise ValueError("Missing the required parameter `id` when calling `api_v2_question_banks_id_delete`")  # noqa: E501
        ...
        return self.api_client.call_api(
            '/api/v2/question_banks/{id}', 'DELETE',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def api_v2_question_banks_id_get(self, id, **kwargs):  # noqa: E501
        """Show question bank  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.api_v2_question_banks_id_get(id, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.api_v2_question_banks_id_get_with_http_info(id, **kwargs)  # noqa: E501
        else:
            (data) = self.api_v2_question_banks_id_get_with_http_info(id, **kwargs)  # noqa: E501
            return data

    def api_v2_question_banks_id_get_with_http_info(self, id, **kwargs):  # noqa: E501
        """Show question bank  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.api_v2_question_banks_id_get_with_http_info(id, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api_v2_question_banks_id_get" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'id' is set
        if ('id' not in params or
                params['id'] is None):
            raise ValueError("Missing the required parameter `id` when calling `api_v2_question_banks_id_get`")  # noqa: E501
    ...
    def api_v2_question_banks_id_patch(self, id, **kwargs):  # noqa: E501
        """Update question bank  # noqa: E501
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.api_v2_question_banks_id_patch(id, async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param str id: id (required)
        :param QuestionBanksIdBody body:
        :return: None
                 If the method is called asynchronously,
                 returns the request thread.
        """
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.api_v2_question_banks_id_patch_with_http_info(id, **kwargs)  # noqa: E501
        else:
            (data) = self.api_v2_question_banks_id_patch_with_http_info(id, **kwargs)  # noqa: E501
            return data

    def api_v2_question_banks_id_patch_with_http_info(self, id, **kwargs):  # noqa: E501
        """Update question bank  # noqa: E501

        To update from one role to another,         the user must first be removed from the current role list and with a new request added to the chosen role list  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.api_v2_question_banks_id_patch_with_http_info(id, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api_v2_question_banks_id_patch" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'id' is set
        if ('id' not in params or
                params['id'] is None):
            raise ValueError("Missing the required parameter `id` when calling `api_v2_question_banks_id_patch`")  # noqa: E501
        ...
        return self.api_client.call_api(
            '/api/v2/question_banks/{id}', 'PATCH',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def api_v2_question_banks_post(self, **kwargs):  # noqa: E501
        """Create question bank  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.api_v2_question_banks_post(async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param V2QuestionBanksBody body:
        :return: None
                 If the method is called asynchronously,
                 returns the request thread.
        """
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.api_v2_question_banks_post_with_http_info(**kwargs)  # noqa: E501
        else:
            (data) = self.api_v2_question_banks_post_with_http_info(**kwargs)  # noqa: E501
            return data

    def api_v2_question_banks_post_with_http_info(self, **kwargs):  # noqa: E501
        """Create question bank  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.api_v2_question_banks_post_with_http_info(async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api_v2_question_banks_post" % key
                )
            params[key] = val
        del params['kwargs']
