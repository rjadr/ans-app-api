...
class ResultFilesApi(object):
    ...
    def api_v2_files_id_delete(self, id, **kwargs):  # noqa: E501
        """Delete file  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.api_v2_files_id_delete(id, async_req=True)
        >>> result = thread.get()
        ...
        if kwargs.get('async_req'):
            return self.api_v2_files_id_delete_with_http_info(id, **kwargs)  # noqa: E501
        else:
            (data) = self.api_v2_files_id_delete_with_http_info(id, **kwargs)  # noqa: E501
            return data

    def api_v2_files_id_delete_with_http_info(self, id, **kwargs):  # noqa: E501
        """Delete file  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.api_v2_files_id_delete_with_http_info(id, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    ...
                    " to method api_v2_files_id_delete" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        if ('id' not in params or
                params['id'] is None):
            raise ValueError("Missing the required parameter `id` when calling `api_v2_files_id_delete`")  # noqa: E501
    ...
    def api_v2_results_result_id_files_new_get(self, result_id, **kwargs):  # noqa: E501
        """Request url to upload a file  # noqa: E501

        Before importing a file you must create a result in the hand-in assignment. Use the result ID and                    a file name of your choosing to request an upload URL and a file key.                    This key can be used to create a file instance using a POST request. After the file has been                    uploaded and the instance created, you must change the result status to `submitted` to submit the                    result  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.api_v2_results_result_id_files_new_get(result_id, async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param str result_id: result_id (required)
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.api_v2_results_result_id_files_new_get_with_http_info(result_id, **kwargs)  # noqa: E501
        else:
            (data) = self.api_v2_results_result_id_files_new_get_with_http_info(result_id, **kwargs)  # noqa: E501
            return data

    def api_v2_results_result_id_files_new_get_with_http_info(self, result_id, **kwargs):  # noqa: E501
        """Request url to upload a file  # noqa: E501

        Before importing a file you must create a result in the hand-in assignment. Use the result ID and                    a file name of your choosing to request an upload URL and a file key.                    This key can be used to create a file instance using a POST request. After the file has been                    uploaded and the instance created, you must change the result status to `submitted` to submit the                    result  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.api_v2_results_result_id_files_new_get_with_http_info(result_id, async_req=True)
        >>> result = thread.get()
        ...
        all_params = ['result_id', 'file_name', 'file_size']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api_v2_results_result_id_files_new_get" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        if ('result_id' not in params or
            ...
            raise ValueError("Missing the required parameter `result_id` when calling `api_v2_results_result_id_files_new_get`")  # noqa: E501
        ...
        return self.api_client.call_api(
            '/api/v2/results/{result_id}/files/new', 'GET',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def api_v2_results_result_id_files_post(self, result_id, **kwargs):  # noqa: E501
        """Create file  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.api_v2_results_result_id_files_post(result_id, async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param str result_id: result_id (required)
        :param ResultIdFilesBody body:
        :return: InlineResponse2014
                 If the method is called asynchronously,
                 returns the request thread.
        """
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.api_v2_results_result_id_files_post_with_http_info(result_id, **kwargs)  # noqa: E501
        else:
            (data) = self.api_v2_results_result_id_files_post_with_http_info(result_id, **kwargs)  # noqa: E501
            return data

    def api_v2_results_result_id_files_post_with_http_info(self, result_id, **kwargs):  # noqa: E501
        """Create file  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.api_v2_results_result_id_files_post_with_http_info(result_id, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api_v2_results_result_id_files_post" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'result_id' is set
        if ('result_id' not in params or
                params['result_id'] is None):
            raise ValueError("Missing the required parameter `result_id` when calling `api_v2_results_result_id_files_post`")  # noqa: E501
        ...
        return self.api_client.call_api(
            '/api/v2/results/{result_id}/files', 'POST',
            path_params,
            query_params,
            header_params,
            body=body_params,
