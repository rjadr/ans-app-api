...
class ClassesApi(object):
    ...
    def api_v2_classes_id_delete(self, id, **kwargs):  # noqa: E501
        """Delete class  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.api_v2_classes_id_delete(id, async_req=True)
        >>> result = thread.get()
        ...
        if kwargs.get('async_req'):
            return self.api_v2_classes_id_delete_with_http_info(id, **kwargs)  # noqa: E501
        else:
            (data) = self.api_v2_classes_id_delete_with_http_info(id, **kwargs)  # noqa: E501
            return data

    def api_v2_classes_id_delete_with_http_info(self, id, **kwargs):  # noqa: E501
        """Delete class  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.api_v2_classes_id_delete_with_http_info(id, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    ...
                    " to method api_v2_classes_id_delete" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        if ('id' not in params or
                params['id'] is None):
            raise ValueError("Missing the required parameter `id` when calling `api_v2_classes_id_delete`")  # noqa: E501
    ...
    def api_v2_classes_id_get(self, id, **kwargs):  # noqa: E501
        """Show class  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.api_v2_classes_id_get(id, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.api_v2_classes_id_get_with_http_info(id, **kwargs)  # noqa: E501
        else:
            (data) = self.api_v2_classes_id_get_with_http_info(id, **kwargs)  # noqa: E501
            return data

    def api_v2_classes_id_get_with_http_info(self, id, **kwargs):  # noqa: E501
        """Show class  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.api_v2_classes_id_get_with_http_info(id, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api_v2_classes_id_get" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'id' is set
        if ('id' not in params or
                params['id'] is None):
            raise ValueError("Missing the required parameter `id` when calling `api_v2_classes_id_get`")  # noqa: E501
    ...
    def api_v2_classes_id_patch(self, id, **kwargs):  # noqa: E501
        """Update class  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.api_v2_classes_id_patch(id, async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param str id: id (required)
        :param ClassesIdBody body:
        :return: InlineResponse2011
                 If the method is called asynchronously,
                 returns the request thread.
        """
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.api_v2_classes_id_patch_with_http_info(id, **kwargs)  # noqa: E501
        else:
            (data) = self.api_v2_classes_id_patch_with_http_info(id, **kwargs)  # noqa: E501
            return data

    def api_v2_classes_id_patch_with_http_info(self, id, **kwargs):  # noqa: E501
        """Update class  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.api_v2_classes_id_patch_with_http_info(id, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api_v2_classes_id_patch" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'id' is set
        if ('id' not in params or
                params['id'] is None):
            raise ValueError("Missing the required parameter `id` when calling `api_v2_classes_id_patch`")  # noqa: E501
    ...
    def api_v2_schools_school_id_classes_get(self, school_id, **kwargs):  # noqa: E501
        """List Classes  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.api_v2_schools_school_id_classes_get(school_id, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.api_v2_schools_school_id_classes_get_with_http_info(school_id, **kwargs)  # noqa: E501
        else:
            (data) = self.api_v2_schools_school_id_classes_get_with_http_info(school_id, **kwargs)  # noqa: E501
            return data

    def api_v2_schools_school_id_classes_get_with_http_info(self, school_id, **kwargs):  # noqa: E501
        """List Classes  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.api_v2_schools_school_id_classes_get_with_http_info(school_id, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api_v2_schools_school_id_classes_get" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        if ('school_id' not in params or
            ...
            raise ValueError("Missing the required parameter `school_id` when calling `api_v2_schools_school_id_classes_get`")  # noqa: E501
        ...
        return self.api_client.call_api(
            '/api/v2/schools/{school_id}/classes', 'GET',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def api_v2_schools_school_id_classes_post(self, school_id, **kwargs):  # noqa: E501
        """Create classes  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.api_v2_schools_school_id_classes_post(school_id, async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param str school_id: school_id (required)
        :param SchoolIdClassesBody body:
        :return: InlineResponse2011
                 If the method is called asynchronously,
                 returns the request thread.
        """
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.api_v2_schools_school_id_classes_post_with_http_info(school_id, **kwargs)  # noqa: E501
        else:
            (data) = self.api_v2_schools_school_id_classes_post_with_http_info(school_id, **kwargs)  # noqa: E501
            return data

    def api_v2_schools_school_id_classes_post_with_http_info(self, school_id, **kwargs):  # noqa: E501
        """Create classes  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.api_v2_schools_school_id_classes_post_with_http_info(school_id, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api_v2_schools_school_id_classes_post" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'school_id' is set
        if ('school_id' not in params or
                params['school_id'] is None):
            raise ValueError("Missing the required parameter `school_id` when calling `api_v2_schools_school_id_classes_post`")  # noqa: E501
        ...
        return self.api_client.call_api(
            '/api/v2/schools/{school_id}/classes', 'POST',
            path_params,
            query_params,
            header_params,
            body=body_params,
