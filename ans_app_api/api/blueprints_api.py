...
class BlueprintsApi(object):
    ...
    def api_v2_blueprints_id_get(self, id, **kwargs):  # noqa: E501
        """Show blueprint  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.api_v2_blueprints_id_get(id, async_req=True)
        >>> result = thread.get()
        ...
        if kwargs.get('async_req'):
            return self.api_v2_blueprints_id_get_with_http_info(id, **kwargs)  # noqa: E501
        else:
            (data) = self.api_v2_blueprints_id_get_with_http_info(id, **kwargs)  # noqa: E501
            return data

    def api_v2_blueprints_id_get_with_http_info(self, id, **kwargs):  # noqa: E501
        """Show blueprint  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.api_v2_blueprints_id_get_with_http_info(id, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    ...
                    " to method api_v2_blueprints_id_get" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        if ('id' not in params or
                params['id'] is None):
            raise ValueError("Missing the required parameter `id` when calling `api_v2_blueprints_id_get`")  # noqa: E501
    ...
    def api_v2_question_banks_question_bank_id_blueprints_get(self, question_bank_id, **kwargs):  # noqa: E501
        """List blueprints  # noqa: E501

        List all your blueprints  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.api_v2_question_banks_question_bank_id_blueprints_get(question_bank_id, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.api_v2_question_banks_question_bank_id_blueprints_get_with_http_info(question_bank_id, **kwargs)  # noqa: E501
        else:
            (data) = self.api_v2_question_banks_question_bank_id_blueprints_get_with_http_info(question_bank_id, **kwargs)  # noqa: E501
            return data

    def api_v2_question_banks_question_bank_id_blueprints_get_with_http_info(self, question_bank_id, **kwargs):  # noqa: E501
        """List blueprints  # noqa: E501

        List all your blueprints  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.api_v2_question_banks_question_bank_id_blueprints_get_with_http_info(question_bank_id, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api_v2_question_banks_question_bank_id_blueprints_get" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        if ('question_bank_id' not in params or
            ...
            raise ValueError("Missing the required parameter `question_bank_id` when calling `api_v2_question_banks_question_bank_id_blueprints_get`")  # noqa: E501
        ...
        return self.api_client.call_api(
            '/api/v2/question_banks/{question_bank_id}/blueprints', 'GET',
            path_params,
            query_params,
            header_params,
            body=body_params,
