...
class PublicationsApi(object):
    ...
    def api_v2_assignments_assignment_id_publication_get(self, assignment_id, **kwargs):  # noqa: E501
        """Show publication  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.api_v2_assignments_assignment_id_publication_get(assignment_id, async_req=True)
        >>> result = thread.get()
        ...
        if kwargs.get('async_req'):
            return self.api_v2_assignments_assignment_id_publication_get_with_http_info(assignment_id, **kwargs)  # noqa: E501
        else:
            (data) = self.api_v2_assignments_assignment_id_publication_get_with_http_info(assignment_id, **kwargs)  # noqa: E501
            return data

    def api_v2_assignments_assignment_id_publication_get_with_http_info(self, assignment_id, **kwargs):  # noqa: E501
        """Show publication  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.api_v2_assignments_assignment_id_publication_get_with_http_info(assignment_id, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    ...
                    " to method api_v2_assignments_assignment_id_publication_get" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        if ('assignment_id' not in params or
            ...
            raise ValueError("Missing the required parameter `assignment_id` when calling `api_v2_assignments_assignment_id_publication_get`")  # noqa: E501
        ...
        return self.api_client.call_api(
            '/api/v2/assignments/{assignment_id}/publication', 'GET',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def api_v2_assignments_assignment_id_publication_patch(self, assignment_id, **kwargs):  # noqa: E501
        """Update publication  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.api_v2_assignments_assignment_id_publication_patch(assignment_id, async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param str assignment_id: assignment_id (required)
        :param AssignmentIdPublicationBody body:
        :return: None
                 If the method is called asynchronously,
                 returns the request thread.
        """
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.api_v2_assignments_assignment_id_publication_patch_with_http_info(assignment_id, **kwargs)  # noqa: E501
        else:
            (data) = self.api_v2_assignments_assignment_id_publication_patch_with_http_info(assignment_id, **kwargs)  # noqa: E501
            return data

    def api_v2_assignments_assignment_id_publication_patch_with_http_info(self, assignment_id, **kwargs):  # noqa: E501
        """Update publication  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.api_v2_assignments_assignment_id_publication_patch_with_http_info(assignment_id, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api_v2_assignments_assignment_id_publication_patch" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'assignment_id' is set
        if ('assignment_id' not in params or
                params['assignment_id'] is None):
            raise ValueError("Missing the required parameter `assignment_id` when calling `api_v2_assignments_assignment_id_publication_patch`")  # noqa: E501
        ...
        return self.api_client.call_api(
            '/api/v2/assignments/{assignment_id}/publication', 'PATCH',
            path_params,
            query_params,
            header_params,
            body=body_params,
