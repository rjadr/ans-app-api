...
class PlanIdSubscriptionsBody(object):
    ...
    def __init__(self, start_date=None, end_date=None, external_id=None, reference=None):  # noqa: E501
        """PlanIdSubscriptionsBody - a model defined in Swagger"""  # noqa: E501
    ...
    @property
    def start_date(self):
        """Gets the start_date of this PlanIdSubscriptionsBody.  # noqa: E501

        Start date of the subscription  # noqa: E501

        :return: The start_date of this PlanIdSubscriptionsBody.  # noqa: E501
        :rtype: date
        """
    ...
    def start_date(self, start_date):
        """Sets the start_date of this PlanIdSubscriptionsBody.

        Start date of the subscription  # noqa: E501

        :param start_date: The start_date of this PlanIdSubscriptionsBody.  # noqa: E501
        :type: date
        """
    ...
    @property
    def end_date(self):
        """Gets the end_date of this PlanIdSubscriptionsBody.  # noqa: E501

        End date of the subscription  # noqa: E501

        :return: The end_date of this PlanIdSubscriptionsBody.  # noqa: E501
        :rtype: date
        """
    ...
    def end_date(self, end_date):
        """Sets the end_date of this PlanIdSubscriptionsBody.

        End date of the subscription  # noqa: E501

        :param end_date: The end_date of this PlanIdSubscriptionsBody.  # noqa: E501
        :type: date
        """
        if end_date is None:
    ...
    def external_id(self):
        """Gets the external_id of this PlanIdSubscriptionsBody.  # noqa: E501

        An external id to reference the subscription  # noqa: E501

        :return: The external_id of this PlanIdSubscriptionsBody.  # noqa: E501
        :rtype: str
        """
    ...
    def external_id(self, external_id):
        """Sets the external_id of this PlanIdSubscriptionsBody.

        An external id to reference the subscription  # noqa: E501

        :param external_id: The external_id of this PlanIdSubscriptionsBody.  # noqa: E501
        :type: str
        """
    ...
    @property
    def reference(self):
        """Gets the reference of this PlanIdSubscriptionsBody.  # noqa: E501

        Reference of the subscription, for example an order number  # noqa: E501

        :return: The reference of this PlanIdSubscriptionsBody.  # noqa: E501
        :rtype: str
        """
    ...
    def reference(self, reference):
        """Sets the reference of this PlanIdSubscriptionsBody.

        Reference of the subscription, for example an order number  # noqa: E501

        :param reference: The reference of this PlanIdSubscriptionsBody.  # noqa: E501
        :type: str
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(PlanIdSubscriptionsBody, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, PlanIdSubscriptionsBody):
            return False
