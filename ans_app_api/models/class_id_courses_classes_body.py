...
class ClassIdCoursesClassesBody(object):
    ...
    def __init__(self, course_id=None):  # noqa: E501
        """ClassIdCoursesClassesBody - a model defined in Swagger"""  # noqa: E501
    ...
    @property
    def course_id(self):
        """Gets the course_id of this ClassIdCoursesClassesBody.  # noqa: E501

        The id of the course to which the class will be added  # noqa: E501

        :return: The course_id of this ClassIdCoursesClassesBody.  # noqa: E501
        :rtype: int
        """
    ...
    def course_id(self, course_id):
        """Sets the course_id of this ClassIdCoursesClassesBody.

        The id of the course to which the class will be added  # noqa: E501

        :param course_id: The course_id of this ClassIdCoursesClassesBody.  # noqa: E501
        :type: int
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(ClassIdCoursesClassesBody, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ClassIdCoursesClassesBody):
            return False
