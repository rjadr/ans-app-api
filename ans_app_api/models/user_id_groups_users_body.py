...
class UserIdGroupsUsersBody(object):
    ...
    def __init__(self, group_id=None):  # noqa: E501
        """UserIdGroupsUsersBody - a model defined in Swagger"""  # noqa: E501
        self._group_id = None
    ...
    @property
    def group_id(self):
        """Gets the group_id of this UserIdGroupsUsersBody.  # noqa: E501

        The id of the group where the user should be added. A maximum of 2500 users can be added to a group.  # noqa: E501

        :return: The group_id of this UserIdGroupsUsersBody.  # noqa: E501
        :rtype: int
        """
    ...
    def group_id(self, group_id):
        """Sets the group_id of this UserIdGroupsUsersBody.

        The id of the group where the user should be added. A maximum of 2500 users can be added to a group.  # noqa: E501

        :param group_id: The group_id of this UserIdGroupsUsersBody.  # noqa: E501
        :type: int
        """
        if group_id is None:
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(UserIdGroupsUsersBody, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, UserIdGroupsUsersBody):
            return False
