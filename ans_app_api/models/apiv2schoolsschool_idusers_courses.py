...
class Apiv2schoolsschoolIdusersCourses(object):
    ...
    swagger_types = {
        'id': 'int',
        'role': 'OneOfapiv2schoolsschoolIdusersCoursesRole',
        'role_id': 'int',
        'extra_time': 'bool'
    }
    ...
    def __init__(self, id=None, role=None, role_id=None, extra_time=False):  # noqa: E501
        """Apiv2schoolsschoolIdusersCourses - a model defined in Swagger"""  # noqa: E501
        self._id = None
        self._role = None
        self._role_id = None
    ...
    @property
    def id(self):
        """Gets the id of this Apiv2schoolsschoolIdusersCourses.  # noqa: E501


        :return: The id of this Apiv2schoolsschoolIdusersCourses.  # noqa: E501
        :rtype: int
        """
        return self._id
    ...
    @id.setter
    def id(self, id):
        """Sets the id of this Apiv2schoolsschoolIdusersCourses.


        :param id: The id of this Apiv2schoolsschoolIdusersCourses.  # noqa: E501
        :type: int
        """
    ...
    @property
    def role(self):
        """Gets the role of this Apiv2schoolsschoolIdusersCourses.  # noqa: E501

        Sets the role for the user in the course, users with the role [uploader, operator, owner] cannot be enrolled in a course  # noqa: E501

        :return: The role of this Apiv2schoolsschoolIdusersCourses.  # noqa: E501
        :rtype: OneOfapiv2schoolsschoolIdusersCoursesRole
        """
        return self._role

    @role.setter
    def role(self, role):
        """Sets the role of this Apiv2schoolsschoolIdusersCourses.

        Sets the role for the user in the course, users with the role [uploader, operator, owner] cannot be enrolled in a course  # noqa: E501

        :param role: The role of this Apiv2schoolsschoolIdusersCourses.  # noqa: E501
        :type: OneOfapiv2schoolsschoolIdusersCoursesRole
        """
    ...
    @property
    def role_id(self):
        """Gets the role_id of this Apiv2schoolsschoolIdusersCourses.  # noqa: E501


        :return: The role_id of this Apiv2schoolsschoolIdusersCourses.  # noqa: E501
        :rtype: int
        """
    ...
    def role_id(self, role_id):
        """Sets the role_id of this Apiv2schoolsschoolIdusersCourses.


        :param role_id: The role_id of this Apiv2schoolsschoolIdusersCourses.  # noqa: E501
        :type: int
        """
    ...
    @property
    def extra_time(self):
        """Gets the extra_time of this Apiv2schoolsschoolIdusersCourses.  # noqa: E501

        Defines whether the student is allowed to have extra time for assignments within this course that have a timeslot for students with extra time  # noqa: E501

        :return: The extra_time of this Apiv2schoolsschoolIdusersCourses.  # noqa: E501
        :rtype: bool
        """
    ...
    def extra_time(self, extra_time):
        """Sets the extra_time of this Apiv2schoolsschoolIdusersCourses.

        Defines whether the student is allowed to have extra time for assignments within this course that have a timeslot for students with extra time  # noqa: E501

        :param extra_time: The extra_time of this Apiv2schoolsschoolIdusersCourses.  # noqa: E501
        :type: bool
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(Apiv2schoolsschoolIdusersCourses, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, Apiv2schoolsschoolIdusersCourses):
            return False
