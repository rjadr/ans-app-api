...
class SchoolIdClassesBody(object):
    ...
    def __init__(self, name=None, course_ids=None, user_ids=None, year=None, external_id=None):  # noqa: E501
        """SchoolIdClassesBody - a model defined in Swagger"""  # noqa: E501
        self._name = None
    ...
    @property
    def name(self):
        """Gets the name of this SchoolIdClassesBody.  # noqa: E501

        The name of the class  # noqa: E501

        :return: The name of this SchoolIdClassesBody.  # noqa: E501
        :rtype: str
        """
        return self._name
    ...
    @name.setter
    def name(self, name):
        """Sets the name of this SchoolIdClassesBody.

        The name of the class  # noqa: E501

        :param name: The name of this SchoolIdClassesBody.  # noqa: E501
        :type: str
        """
        if name is None:
    ...
    @property
    def course_ids(self):
        """Gets the course_ids of this SchoolIdClassesBody.  # noqa: E501

        The ids of courses to which the class will be linked  # noqa: E501

        :return: The course_ids of this SchoolIdClassesBody.  # noqa: E501
        :rtype: list[int]
        """
    ...
    def course_ids(self, course_ids):
        """Sets the course_ids of this SchoolIdClassesBody.

        The ids of courses to which the class will be linked  # noqa: E501

        :param course_ids: The course_ids of this SchoolIdClassesBody.  # noqa: E501
        :type: list[int]
        """
    ...
    @property
    def user_ids(self):
        """Gets the user_ids of this SchoolIdClassesBody.  # noqa: E501
        ...
        :return: The user_ids of this SchoolIdClassesBody.  # noqa: E501
        :rtype: list[int]
        """
    ...
    def user_ids(self, user_ids):
        """Sets the user_ids of this SchoolIdClassesBody.

        The ids of users for the class. A maximum of 1000 users can be added to a class. If more than 1000 values are given, then no users will be added  # noqa: E501

        :param user_ids: The user_ids of this SchoolIdClassesBody.  # noqa: E501
        :type: list[int]
        """
    ...
    @property
    def year(self):
        """Gets the year of this SchoolIdClassesBody.  # noqa: E501

        The year of the class. For schoolyear 2022/2023, use 2022  # noqa: E501

        :return: The year of this SchoolIdClassesBody.  # noqa: E501
        :rtype: int
        """
        return self._year
    ...
    @year.setter
    def year(self, year):
        """Sets the year of this SchoolIdClassesBody.

        The year of the class. For schoolyear 2022/2023, use 2022  # noqa: E501

        :param year: The year of this SchoolIdClassesBody.  # noqa: E501
        :type: int
        """
        if year is None:
    ...
    def external_id(self):
        """Gets the external_id of this SchoolIdClassesBody.  # noqa: E501

        An external id to reference the class  # noqa: E501

        :return: The external_id of this SchoolIdClassesBody.  # noqa: E501
        :rtype: str
        """
    ...
    def external_id(self, external_id):
        """Sets the external_id of this SchoolIdClassesBody.

        An external id to reference the class  # noqa: E501

        :param external_id: The external_id of this SchoolIdClassesBody.  # noqa: E501
        :type: str
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(SchoolIdClassesBody, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, SchoolIdClassesBody):
            return False
