...
class SchoolIdDepartmentsBody(object):
    ...
    def __init__(self, name=None, operator_ids=None, external_id=None):  # noqa: E501
        """SchoolIdDepartmentsBody - a model defined in Swagger"""  # noqa: E501
        self._name = None
    ...
    @property
    def name(self):
        """Gets the name of this SchoolIdDepartmentsBody.  # noqa: E501

        The name of the department  # noqa: E501

        :return: The name of this SchoolIdDepartmentsBody.  # noqa: E501
        :rtype: str
        """
        return self._name
    ...
    @name.setter
    def name(self, name):
        """Sets the name of this SchoolIdDepartmentsBody.

        The name of the department  # noqa: E501

        :param name: The name of this SchoolIdDepartmentsBody.  # noqa: E501
        :type: str
        """
        if name is None:
    ...
    def operator_ids(self):
        """Gets the operator_ids of this SchoolIdDepartmentsBody.  # noqa: E501

        An array of user ids that have the operator role that will be added to the department  # noqa: E501

        :return: The operator_ids of this SchoolIdDepartmentsBody.  # noqa: E501
        :rtype: list[int]
        """
    ...
    def operator_ids(self, operator_ids):
        """Sets the operator_ids of this SchoolIdDepartmentsBody.

        An array of user ids that have the operator role that will be added to the department  # noqa: E501

        :param operator_ids: The operator_ids of this SchoolIdDepartmentsBody.  # noqa: E501
        :type: list[int]
        """
    ...
    def external_id(self):
        """Gets the external_id of this SchoolIdDepartmentsBody.  # noqa: E501

        An external id to reference the department  # noqa: E501

        :return: The external_id of this SchoolIdDepartmentsBody.  # noqa: E501
        :rtype: str
        """
    ...
    def external_id(self, external_id):
        """Sets the external_id of this SchoolIdDepartmentsBody.

        An external id to reference the department  # noqa: E501

        :param external_id: The external_id of this SchoolIdDepartmentsBody.  # noqa: E501
        :type: str
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(SchoolIdDepartmentsBody, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, SchoolIdDepartmentsBody):
            return False
