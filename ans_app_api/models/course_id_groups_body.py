...
class CourseIdGroupsBody(object):
    ...
    def __init__(self, name=None, user_ids=None, external_id=None, can_start_assignment=None, learners_can_join_or_leave=None):  # noqa: E501
        """CourseIdGroupsBody - a model defined in Swagger"""  # noqa: E501
        self._name = None
        self._user_ids = None
    ...
    @property
    def name(self):
        """Gets the name of this CourseIdGroupsBody.  # noqa: E501

        The name of the group in the course  # noqa: E501

        :return: The name of this CourseIdGroupsBody.  # noqa: E501
        :rtype: str
        """
        return self._name
    ...
    @name.setter
    def name(self, name):
        """Sets the name of this CourseIdGroupsBody.

        The name of the group in the course  # noqa: E501

        :param name: The name of this CourseIdGroupsBody.  # noqa: E501
        :type: str
        """
        if name is None:
    ...
    @property
    def user_ids(self):
        """Gets the user_ids of this CourseIdGroupsBody.  # noqa: E501

        An array of user ids that will be added to the group. A maximum of 2500 users can be added to a group.  # noqa: E501

        :return: The user_ids of this CourseIdGroupsBody.  # noqa: E501
        :rtype: list[int]
        """
    ...
    def user_ids(self, user_ids):
        """Sets the user_ids of this CourseIdGroupsBody.

        An array of user ids that will be added to the group. A maximum of 2500 users can be added to a group.  # noqa: E501

        :param user_ids: The user_ids of this CourseIdGroupsBody.  # noqa: E501
        :type: list[int]
        """
    ...
    def external_id(self):
        """Gets the external_id of this CourseIdGroupsBody.  # noqa: E501

        An external id to reference the group  # noqa: E501

        :return: The external_id of this CourseIdGroupsBody.  # noqa: E501
        :rtype: str
        """
    ...
    def external_id(self, external_id):
        """Sets the external_id of this CourseIdGroupsBody.

        An external id to reference the group  # noqa: E501

        :param external_id: The external_id of this CourseIdGroupsBody.  # noqa: E501
        :type: str
        """
    ...
    def can_start_assignment(self):
        """Gets the can_start_assignment of this CourseIdGroupsBody.  # noqa: E501

        This group can start or hand in a group assignment  # noqa: E501

        :return: The can_start_assignment of this CourseIdGroupsBody.  # noqa: E501
        :rtype: bool
        """
    ...
    def can_start_assignment(self, can_start_assignment):
        """Sets the can_start_assignment of this CourseIdGroupsBody.

        This group can start or hand in a group assignment  # noqa: E501

        :param can_start_assignment: The can_start_assignment of this CourseIdGroupsBody.  # noqa: E501
        :type: bool
        """
    ...
    def learners_can_join_or_leave(self):
        """Gets the learners_can_join_or_leave of this CourseIdGroupsBody.  # noqa: E501

        Learners may join or leave this group  # noqa: E501

        :return: The learners_can_join_or_leave of this CourseIdGroupsBody.  # noqa: E501
        :rtype: bool
        """
    ...
    def learners_can_join_or_leave(self, learners_can_join_or_leave):
        """Sets the learners_can_join_or_leave of this CourseIdGroupsBody.

        Learners may join or leave this group  # noqa: E501

        :param learners_can_join_or_leave: The learners_can_join_or_leave of this CourseIdGroupsBody.  # noqa: E501
        :type: bool
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(CourseIdGroupsBody, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, CourseIdGroupsBody):
            return False
