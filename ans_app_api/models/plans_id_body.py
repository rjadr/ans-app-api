...
class PlansIdBody(object):
    ...
    def __init__(self, name=None, nickname=None, external_id=None):  # noqa: E501
        """PlansIdBody - a model defined in Swagger"""  # noqa: E501
        self._name = None
        self._nickname = None
    ...
    @property
    def name(self):
        """Gets the name of this PlansIdBody.  # noqa: E501

        The name of the plan  # noqa: E501

        :return: The name of this PlansIdBody.  # noqa: E501
        :rtype: str
        """
        return self._name
    ...
    @name.setter
    def name(self, name):
        """Sets the name of this PlansIdBody.

        The name of the plan  # noqa: E501

        :param name: The name of this PlansIdBody.  # noqa: E501
        :type: str
        """
        if name is None:
    ...
    @property
    def nickname(self):
        """Gets the nickname of this PlansIdBody.  # noqa: E501

        The nickname of the plan  # noqa: E501

        :return: The nickname of this PlansIdBody.  # noqa: E501
        :rtype: str
        """
    ...
    def nickname(self, nickname):
        """Sets the nickname of this PlansIdBody.

        The nickname of the plan  # noqa: E501

        :param nickname: The nickname of this PlansIdBody.  # noqa: E501
        :type: str
        """
        if nickname is None:
    ...
    def external_id(self):
        """Gets the external_id of this PlansIdBody.  # noqa: E501

        An external id to reference the plan  # noqa: E501

        :return: The external_id of this PlansIdBody.  # noqa: E501
        :rtype: str
        """
    ...
    def external_id(self, external_id):
        """Sets the external_id of this PlansIdBody.

        An external id to reference the plan  # noqa: E501

        :param external_id: The external_id of this PlansIdBody.  # noqa: E501
        :type: str
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(PlansIdBody, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, PlansIdBody):
            return False
