...
class V2WebhooksBody(object):
    ...
    def __init__(self, url=None, subscriptions=None, enabled=True):  # noqa: E501
        """V2WebhooksBody - a model defined in Swagger"""  # noqa: E501
        self._url = None
    ...
    @property
    def url(self):
        """Gets the url of this V2WebhooksBody.  # noqa: E501

        The url the webhook will send the data towards  # noqa: E501

        :return: The url of this V2WebhooksBody.  # noqa: E501
        :rtype: str
        """
        return self._url
    ...
    @url.setter
    def url(self, url):
        """Sets the url of this V2WebhooksBody.

        The url the webhook will send the data towards  # noqa: E501

        :param url: The url of this V2WebhooksBody.  # noqa: E501
        :type: str
        """
        if url is None:
    ...
    def subscriptions(self):
        """Gets the subscriptions of this V2WebhooksBody.  # noqa: E501

        Specify subscriptions, for example ['*'], ['assignment'] or ['assignment.create']  # noqa: E501

        :return: The subscriptions of this V2WebhooksBody.  # noqa: E501
        :rtype: list[str]
        """
    ...
    def subscriptions(self, subscriptions):
        """Sets the subscriptions of this V2WebhooksBody.

        Specify subscriptions, for example ['*'], ['assignment'] or ['assignment.create']  # noqa: E501

        :param subscriptions: The subscriptions of this V2WebhooksBody.  # noqa: E501
        :type: list[str]
        """
    ...
    @property
    def enabled(self):
        """Gets the enabled of this V2WebhooksBody.  # noqa: E501

        Defines whether the webhook is enabled  # noqa: E501

        :return: The enabled of this V2WebhooksBody.  # noqa: E501
        :rtype: bool
        """
    ...
    def enabled(self, enabled):
        """Sets the enabled of this V2WebhooksBody.

        Defines whether the webhook is enabled  # noqa: E501

        :param enabled: The enabled of this V2WebhooksBody.  # noqa: E501
        :type: bool
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(V2WebhooksBody, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, V2WebhooksBody):
            return False
