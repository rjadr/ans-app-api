...
class DomainIdObjectivesBody(object):
    ...
    def __init__(self, name=None, position=None, external_id=None):  # noqa: E501
        """DomainIdObjectivesBody - a model defined in Swagger"""  # noqa: E501
        self._name = None
        self._position = None
    ...
    @property
    def name(self):
        """Gets the name of this DomainIdObjectivesBody.  # noqa: E501

        The name of the objective  # noqa: E501

        :return: The name of this DomainIdObjectivesBody.  # noqa: E501
        :rtype: str
        """
        return self._name
    ...
    @name.setter
    def name(self, name):
        """Sets the name of this DomainIdObjectivesBody.

        The name of the objective  # noqa: E501

        :param name: The name of this DomainIdObjectivesBody.  # noqa: E501
        :type: str
        """
        if name is None:
    ...
    @property
    def position(self):
        """Gets the position of this DomainIdObjectivesBody.  # noqa: E501

        Defines the position of the objective within the domain  # noqa: E501

        :return: The position of this DomainIdObjectivesBody.  # noqa: E501
        :rtype: int
        """
    ...
    def position(self, position):
        """Sets the position of this DomainIdObjectivesBody.

        Defines the position of the objective within the domain  # noqa: E501

        :param position: The position of this DomainIdObjectivesBody.  # noqa: E501
        :type: int
        """
    ...
    def external_id(self):
        """Gets the external_id of this DomainIdObjectivesBody.  # noqa: E501

        An external id to reference the objective  # noqa: E501

        :return: The external_id of this DomainIdObjectivesBody.  # noqa: E501
        :rtype: str
        """
    ...
    def external_id(self, external_id):
        """Sets the external_id of this DomainIdObjectivesBody.

        An external id to reference the objective  # noqa: E501

        :param external_id: The external_id of this DomainIdObjectivesBody.  # noqa: E501
        :type: str
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(DomainIdObjectivesBody, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, DomainIdObjectivesBody):
            return False
