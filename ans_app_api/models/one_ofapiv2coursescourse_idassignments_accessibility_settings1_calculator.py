...
class OneOfapiv2coursescourseIdassignmentsAccessibilitySettings1Calculator(object):
    ...
    def __init__(self):  # noqa: E501
        """OneOfapiv2coursescourseIdassignmentsAccessibilitySettings1Calculator - a model defined in Swagger"""  # noqa: E501
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(OneOfapiv2coursescourseIdassignmentsAccessibilitySettings1Calculator, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, OneOfapiv2coursescourseIdassignmentsAccessibilitySettings1Calculator):
            return False
