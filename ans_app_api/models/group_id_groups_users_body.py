...
class GroupIdGroupsUsersBody(object):
    ...
    def __init__(self, user_id=None):  # noqa: E501
        """GroupIdGroupsUsersBody - a model defined in Swagger"""  # noqa: E501
        self._user_id = None
    ...
    @property
    def user_id(self):
        """Gets the user_id of this GroupIdGroupsUsersBody.  # noqa: E501

        The id of the user to add to the group. A maximum of 2500 users can be added to a group.  # noqa: E501

        :return: The user_id of this GroupIdGroupsUsersBody.  # noqa: E501
        :rtype: int
        """
    ...
    def user_id(self, user_id):
        """Sets the user_id of this GroupIdGroupsUsersBody.

        The id of the user to add to the group. A maximum of 2500 users can be added to a group.  # noqa: E501

        :param user_id: The user_id of this GroupIdGroupsUsersBody.  # noqa: E501
        :type: int
        """
        if user_id is None:
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(GroupIdGroupsUsersBody, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, GroupIdGroupsUsersBody):
            return False
