...
class AssignmentIdExercisesBody(object):
    ...
    def __init__(self, name=None, external_id=None, new_page=False):  # noqa: E501
        """AssignmentIdExercisesBody - a model defined in Swagger"""  # noqa: E501
        self._name = None
    ...
    @property
    def name(self):
        """Gets the name of this AssignmentIdExercisesBody.  # noqa: E501

        The name of the assignment exercise  # noqa: E501

        :return: The name of this AssignmentIdExercisesBody.  # noqa: E501
        :rtype: str
        """
        return self._name
    ...
    @name.setter
    def name(self, name):
        """Sets the name of this AssignmentIdExercisesBody.

        The name of the assignment exercise  # noqa: E501

        :param name: The name of this AssignmentIdExercisesBody.  # noqa: E501
        :type: str
        """
        if name is None:
    ...
    def external_id(self):
        """Gets the external_id of this AssignmentIdExercisesBody.  # noqa: E501

        An external id to reference the exercise  # noqa: E501

        :return: The external_id of this AssignmentIdExercisesBody.  # noqa: E501
        :rtype: str
        """
    ...
    def external_id(self, external_id):
        """Sets the external_id of this AssignmentIdExercisesBody.

        An external id to reference the exercise  # noqa: E501

        :param external_id: The external_id of this AssignmentIdExercisesBody.  # noqa: E501
        :type: str
        """
    ...
    @property
    def new_page(self):
        """Gets the new_page of this AssignmentIdExercisesBody.  # noqa: E501

        Defines whether the exercise will start on a new page  # noqa: E501

        :return: The new_page of this AssignmentIdExercisesBody.  # noqa: E501
        :rtype: bool
        """
    ...
    def new_page(self, new_page):
        """Sets the new_page of this AssignmentIdExercisesBody.

        Defines whether the exercise will start on a new page  # noqa: E501

        :param new_page: The new_page of this AssignmentIdExercisesBody.  # noqa: E501
        :type: bool
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(AssignmentIdExercisesBody, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, AssignmentIdExercisesBody):
            return False
