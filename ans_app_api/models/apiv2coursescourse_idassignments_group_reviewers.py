...
class Apiv2coursescourseIdassignmentsGroupReviewers(object):
    ...
    def __init__(self, reviewer_id=None, group_ids=None):  # noqa: E501
        """Apiv2coursescourseIdassignmentsGroupReviewers - a model defined in Swagger"""  # noqa: E501
    ...
    def reviewer_id(self):
        """Gets the reviewer_id of this Apiv2coursescourseIdassignmentsGroupReviewers.  # noqa: E501

        The identifier of the reviewer or instructor assigned to review groups. Instructors have the ability to review all groups even when the group_ids array is empty  # noqa: E501

        :return: The reviewer_id of this Apiv2coursescourseIdassignmentsGroupReviewers.  # noqa: E501
        :rtype: int
        """
    ...
    def reviewer_id(self, reviewer_id):
        """Sets the reviewer_id of this Apiv2coursescourseIdassignmentsGroupReviewers.

        The identifier of the reviewer or instructor assigned to review groups. Instructors have the ability to review all groups even when the group_ids array is empty  # noqa: E501

        :param reviewer_id: The reviewer_id of this Apiv2coursescourseIdassignmentsGroupReviewers.  # noqa: E501
        :type: int
        """
    ...
    @property
    def group_ids(self):
        """Gets the group_ids of this Apiv2coursescourseIdassignmentsGroupReviewers.  # noqa: E501

        The identifiers of the groups which will be assigned to the reviewer  # noqa: E501

        :return: The group_ids of this Apiv2coursescourseIdassignmentsGroupReviewers.  # noqa: E501
        :rtype: list[int]
        """
    ...
    def group_ids(self, group_ids):
        """Sets the group_ids of this Apiv2coursescourseIdassignmentsGroupReviewers.

        The identifiers of the groups which will be assigned to the reviewer  # noqa: E501

        :param group_ids: The group_ids of this Apiv2coursescourseIdassignmentsGroupReviewers.  # noqa: E501
        :type: list[int]
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(Apiv2coursescourseIdassignmentsGroupReviewers, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, Apiv2coursescourseIdassignmentsGroupReviewers):
            return False
