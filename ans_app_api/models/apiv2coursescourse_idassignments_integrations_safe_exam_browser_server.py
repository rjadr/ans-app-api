...
class Apiv2coursescourseIdassignmentsIntegrationsSafeExamBrowserServer(object):
    ...
    def __init__(self, enabled=None, config_keys=None):  # noqa: E501
        """Apiv2coursescourseIdassignmentsIntegrationsSafeExamBrowserServer - a model defined in Swagger"""  # noqa: E501
        self._enabled = None
    ...
    @property
    def enabled(self):
        """Gets the enabled of this Apiv2coursescourseIdassignmentsIntegrationsSafeExamBrowserServer.  # noqa: E501


        :return: The enabled of this Apiv2coursescourseIdassignmentsIntegrationsSafeExamBrowserServer.  # noqa: E501
        :rtype: bool
        """
    ...
    def enabled(self, enabled):
        """Sets the enabled of this Apiv2coursescourseIdassignmentsIntegrationsSafeExamBrowserServer.


        :param enabled: The enabled of this Apiv2coursescourseIdassignmentsIntegrationsSafeExamBrowserServer.  # noqa: E501
        :type: bool
        """
    ...
    def config_keys(self):
        """Gets the config_keys of this Apiv2coursescourseIdassignmentsIntegrationsSafeExamBrowserServer.  # noqa: E501


        :return: The config_keys of this Apiv2coursescourseIdassignmentsIntegrationsSafeExamBrowserServer.  # noqa: E501
        :rtype: list[str]
        """
    ...
    def config_keys(self, config_keys):
        """Sets the config_keys of this Apiv2coursescourseIdassignmentsIntegrationsSafeExamBrowserServer.


        :param config_keys: The config_keys of this Apiv2coursescourseIdassignmentsIntegrationsSafeExamBrowserServer.  # noqa: E501
        :type: list[str]
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(Apiv2coursescourseIdassignmentsIntegrationsSafeExamBrowserServer, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, Apiv2coursescourseIdassignmentsIntegrationsSafeExamBrowserServer):
            return False
