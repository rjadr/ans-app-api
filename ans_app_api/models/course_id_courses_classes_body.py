...
class CourseIdCoursesClassesBody(object):
    ...
    def __init__(self, class_id=None):  # noqa: E501
        """CourseIdCoursesClassesBody - a model defined in Swagger"""  # noqa: E501
        self._class_id = None
    ...
    @property
    def class_id(self):
        """Gets the class_id of this CourseIdCoursesClassesBody.  # noqa: E501

        The id of the class to add to the course  # noqa: E501

        :return: The class_id of this CourseIdCoursesClassesBody.  # noqa: E501
        :rtype: int
        """
    ...
    def class_id(self, class_id):
        """Sets the class_id of this CourseIdCoursesClassesBody.

        The id of the class to add to the course  # noqa: E501

        :param class_id: The class_id of this CourseIdCoursesClassesBody.  # noqa: E501
        :type: int
        """
        if class_id is None:
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(CourseIdCoursesClassesBody, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, CourseIdCoursesClassesBody):
            return False
