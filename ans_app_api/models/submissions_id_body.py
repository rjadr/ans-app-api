...
class SubmissionsIdBody(object):
    ...
    def __init__(self, raw_score=None):  # noqa: E501
        """SubmissionsIdBody - a model defined in Swagger"""  # noqa: E501
    ...
    @property
    def raw_score(self):
        """Gets the raw_score of this SubmissionsIdBody.  # noqa: E501

        The raw score of the submission. You can set the raw_score to a desired score when the question grading type is set to slider. Ans combines the raw_score with adjustments to calculate the score of the submission.  # noqa: E501

        :return: The raw_score of this SubmissionsIdBody.  # noqa: E501
        :rtype: object
        """
    ...
    def raw_score(self, raw_score):
        """Sets the raw_score of this SubmissionsIdBody.

        The raw score of the submission. You can set the raw_score to a desired score when the question grading type is set to slider. Ans combines the raw_score with adjustments to calculate the score of the submission.  # noqa: E501

        :param raw_score: The raw_score of this SubmissionsIdBody.  # noqa: E501
        :type: object
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(SubmissionsIdBody, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, SubmissionsIdBody):
            return False
