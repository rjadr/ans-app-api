...
class StudiesIdBody(object):
    ...
    def __init__(self, name=None, external_id=None):  # noqa: E501
        """StudiesIdBody - a model defined in Swagger"""  # noqa: E501
        self._name = None
    ...
    @property
    def name(self):
        """Gets the name of this StudiesIdBody.  # noqa: E501

        The name of the study  # noqa: E501

        :return: The name of this StudiesIdBody.  # noqa: E501
        :rtype: str
        """
        return self._name
    ...
    @name.setter
    def name(self, name):
        """Sets the name of this StudiesIdBody.

        The name of the study  # noqa: E501

        :param name: The name of this StudiesIdBody.  # noqa: E501
        :type: str
        """
        if name is None:
    ...
    def external_id(self):
        """Gets the external_id of this StudiesIdBody.  # noqa: E501

        An external id to reference the study  # noqa: E501

        :return: The external_id of this StudiesIdBody.  # noqa: E501
        :rtype: str
        """
    ...
    def external_id(self, external_id):
        """Sets the external_id of this StudiesIdBody.

        An external id to reference the study  # noqa: E501

        :param external_id: The external_id of this StudiesIdBody.  # noqa: E501
        :type: str
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(StudiesIdBody, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, StudiesIdBody):
            return False
