...
class Apiv2coursescourseIdassignmentsIntegrationsSafeExamBrowser(object):
    ...
    """
    swagger_types = {
        'config': 'Apiv2coursescourseIdassignmentsIntegrationsSafeExamBrowserConfig'
    }
    ...
    def __init__(self, config=None):  # noqa: E501
        """Apiv2coursescourseIdassignmentsIntegrationsSafeExamBrowser - a model defined in Swagger"""  # noqa: E501
        self._config = None
    ...
    @property
    def config(self):
        """Gets the config of this Apiv2coursescourseIdassignmentsIntegrationsSafeExamBrowser.  # noqa: E501


        :return: The config of this Apiv2coursescourseIdassignmentsIntegrationsSafeExamBrowser.  # noqa: E501
        :rtype: Apiv2coursescourseIdassignmentsIntegrationsSafeExamBrowserConfig
        """
        return self._config

    @config.setter
    def config(self, config):
        """Sets the config of this Apiv2coursescourseIdassignmentsIntegrationsSafeExamBrowser.


        :param config: The config of this Apiv2coursescourseIdassignmentsIntegrationsSafeExamBrowser.  # noqa: E501
        :type: Apiv2coursescourseIdassignmentsIntegrationsSafeExamBrowserConfig
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(Apiv2coursescourseIdassignmentsIntegrationsSafeExamBrowser, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, Apiv2coursescourseIdassignmentsIntegrationsSafeExamBrowser):
            return False
