...
class LocationsIdBody(object):
    ...
    def __init__(self, name=None, external_id=None, ip_range=None):  # noqa: E501
        """LocationsIdBody - a model defined in Swagger"""  # noqa: E501
        self._name = None
    ...
    @property
    def name(self):
        """Gets the name of this LocationsIdBody.  # noqa: E501

        The name of the location  # noqa: E501

        :return: The name of this LocationsIdBody.  # noqa: E501
        :rtype: str
        """
        return self._name
    ...
    @name.setter
    def name(self, name):
        """Sets the name of this LocationsIdBody.

        The name of the location  # noqa: E501

        :param name: The name of this LocationsIdBody.  # noqa: E501
        :type: str
        """
        if name is None:
    ...
    def external_id(self):
        """Gets the external_id of this LocationsIdBody.  # noqa: E501

        An external id to reference the location  # noqa: E501

        :return: The external_id of this LocationsIdBody.  # noqa: E501
        :rtype: str
        """
    ...
    def external_id(self, external_id):
        """Sets the external_id of this LocationsIdBody.

        An external id to reference the location  # noqa: E501

        :param external_id: The external_id of this LocationsIdBody.  # noqa: E501
        :type: str
        """
    ...
    @property
    def ip_range(self):
        """Gets the ip_range of this LocationsIdBody.  # noqa: E501

        The ip of the location. This could also be a range, for example 172.16.254.1-172.16.254.255  # noqa: E501

        :return: The ip_range of this LocationsIdBody.  # noqa: E501
        :rtype: str
        """
    ...
    def ip_range(self, ip_range):
        """Sets the ip_range of this LocationsIdBody.

        The ip of the location. This could also be a range, for example 172.16.254.1-172.16.254.255  # noqa: E501

        :param ip_range: The ip_range of this LocationsIdBody.  # noqa: E501
        :type: str
        """
        if ip_range is None:
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(LocationsIdBody, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, LocationsIdBody):
            return False
