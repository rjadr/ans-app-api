...
class QuestionBanksIdBody(object):
    ...
    def __init__(self, name=None, external_id=None, trashed=False, publisher_ids=None, author_ids=None):  # noqa: E501
        """QuestionBanksIdBody - a model defined in Swagger"""  # noqa: E501
        self._name = None
    ...
    @property
    def name(self):
        """Gets the name of this QuestionBanksIdBody.  # noqa: E501

        The name of the question bank  # noqa: E501

        :return: The name of this QuestionBanksIdBody.  # noqa: E501
        :rtype: str
        """
        return self._name
    ...
    @name.setter
    def name(self, name):
        """Sets the name of this QuestionBanksIdBody.

        The name of the question bank  # noqa: E501

        :param name: The name of this QuestionBanksIdBody.  # noqa: E501
        :type: str
        """
        if name is None:
    ...
    def external_id(self):
        """Gets the external_id of this QuestionBanksIdBody.  # noqa: E501

        An external id to reference the question bank  # noqa: E501

        :return: The external_id of this QuestionBanksIdBody.  # noqa: E501
        :rtype: str
        """
    ...
    def external_id(self, external_id):
        """Sets the external_id of this QuestionBanksIdBody.

        An external id to reference the question bank  # noqa: E501

        :param external_id: The external_id of this QuestionBanksIdBody.  # noqa: E501
        :type: str
        """
    ...
    @property
    def trashed(self):
        """Gets the trashed of this QuestionBanksIdBody.  # noqa: E501

        Defines if a question bank has been soft deleted  # noqa: E501

        :return: The trashed of this QuestionBanksIdBody.  # noqa: E501
        :rtype: bool
        """
    ...
    def trashed(self, trashed):
        """Sets the trashed of this QuestionBanksIdBody.

        Defines if a question bank has been soft deleted  # noqa: E501

        :param trashed: The trashed of this QuestionBanksIdBody.  # noqa: E501
        :type: bool
        """
    ...
    def publisher_ids(self):
        """Gets the publisher_ids of this QuestionBanksIdBody.  # noqa: E501

        User ids that have the publisher role  # noqa: E501

        :return: The publisher_ids of this QuestionBanksIdBody.  # noqa: E501
        :rtype: list[int]
        """
    ...
    def publisher_ids(self, publisher_ids):
        """Sets the publisher_ids of this QuestionBanksIdBody.

        User ids that have the publisher role  # noqa: E501

        :param publisher_ids: The publisher_ids of this QuestionBanksIdBody.  # noqa: E501
        :type: list[int]
        """
    ...
    @property
    def author_ids(self):
        """Gets the author_ids of this QuestionBanksIdBody.  # noqa: E501

        User ids that have the author role  # noqa: E501

        :return: The author_ids of this QuestionBanksIdBody.  # noqa: E501
        :rtype: list[int]
        """
    ...
    def author_ids(self, author_ids):
        """Sets the author_ids of this QuestionBanksIdBody.

        User ids that have the author role  # noqa: E501

        :param author_ids: The author_ids of this QuestionBanksIdBody.  # noqa: E501
        :type: list[int]
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(QuestionBanksIdBody, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, QuestionBanksIdBody):
            return False
