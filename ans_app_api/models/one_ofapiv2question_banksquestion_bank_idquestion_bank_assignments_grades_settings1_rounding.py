...
class OneOfapiv2questionBanksquestionBankIdquestionBankAssignmentsGradesSettings1Rounding(object):
    ...
    def __init__(self):  # noqa: E501
        """OneOfapiv2questionBanksquestionBankIdquestionBankAssignmentsGradesSettings1Rounding - a model defined in Swagger"""  # noqa: E501
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(OneOfapiv2questionBanksquestionBankIdquestionBankAssignmentsGradesSettings1Rounding, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, OneOfapiv2questionBanksquestionBankIdquestionBankAssignmentsGradesSettings1Rounding):
            return False
