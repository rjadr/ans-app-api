...
class Apiv2coursescourseIdassignmentsIntegrations1SafeExamBrowser(object):
    ...
    """
    swagger_types = {
        'config': 'Apiv2coursescourseIdassignmentsIntegrations1SafeExamBrowserConfig'
    }
    ...
    def __init__(self, config=None):  # noqa: E501
        """Apiv2coursescourseIdassignmentsIntegrations1SafeExamBrowser - a model defined in Swagger"""  # noqa: E501
        self._config = None
    ...
    @property
    def config(self):
        """Gets the config of this Apiv2coursescourseIdassignmentsIntegrations1SafeExamBrowser.  # noqa: E501


        :return: The config of this Apiv2coursescourseIdassignmentsIntegrations1SafeExamBrowser.  # noqa: E501
        :rtype: Apiv2coursescourseIdassignmentsIntegrations1SafeExamBrowserConfig
        """
        return self._config

    @config.setter
    def config(self, config):
        """Sets the config of this Apiv2coursescourseIdassignmentsIntegrations1SafeExamBrowser.


        :param config: The config of this Apiv2coursescourseIdassignmentsIntegrations1SafeExamBrowser.  # noqa: E501
        :type: Apiv2coursescourseIdassignmentsIntegrations1SafeExamBrowserConfig
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(Apiv2coursescourseIdassignmentsIntegrations1SafeExamBrowser, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, Apiv2coursescourseIdassignmentsIntegrations1SafeExamBrowser):
            return False
