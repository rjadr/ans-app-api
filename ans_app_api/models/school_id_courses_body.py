...
class SchoolIdCoursesBody(object):
    ...
    def __init__(self, name=None, year=None, course_code=None, self_enroll=False, external_id=None, trashed=False, class_ids=None, study_ids=None, period_ids=None, learners=None, invigilators=None, reviewers=None, instructors=None):  # noqa: E501
        """SchoolIdCoursesBody - a model defined in Swagger"""  # noqa: E501
        self._name = None
        self._year = None
    ...
    @property
    def name(self):
        """Gets the name of this SchoolIdCoursesBody.  # noqa: E501

        The name of the course  # noqa: E501

        :return: The name of this SchoolIdCoursesBody.  # noqa: E501
        :rtype: str
        """
        return self._name
    ...
    @name.setter
    def name(self, name):
        """Sets the name of this SchoolIdCoursesBody.

        The name of the course  # noqa: E501

        :param name: The name of this SchoolIdCoursesBody.  # noqa: E501
        :type: str
        """
        if name is None:
    ...
    @property
    def year(self):
        """Gets the year of this SchoolIdCoursesBody.  # noqa: E501
        ...
        :return: The year of this SchoolIdCoursesBody.  # noqa: E501
        :rtype: int
        """
        return self._year
    ...
    @year.setter
    def year(self, year):
        """Sets the year of this SchoolIdCoursesBody.

        The school year in which the course takes place. For example, select year 2022 for school year 2022/2023. Ans will select the current school year by default if no year is set  # noqa: E501

        :param year: The year of this SchoolIdCoursesBody.  # noqa: E501
        :type: int
        """
    ...
    def course_code(self):
        """Gets the course_code of this SchoolIdCoursesBody.  # noqa: E501

        Code used to refer to the course  # noqa: E501

        :return: The course_code of this SchoolIdCoursesBody.  # noqa: E501
        :rtype: str
        """
    ...
    def course_code(self, course_code):
        """Sets the course_code of this SchoolIdCoursesBody.

        Code used to refer to the course  # noqa: E501

        :param course_code: The course_code of this SchoolIdCoursesBody.  # noqa: E501
        :type: str
        """
    ...
    def self_enroll(self):
        """Gets the self_enroll of this SchoolIdCoursesBody.  # noqa: E501

        Allows a student to enroll themselves in the course if set to true  # noqa: E501

        :return: The self_enroll of this SchoolIdCoursesBody.  # noqa: E501
        :rtype: bool
        """
    ...
    def self_enroll(self, self_enroll):
        """Sets the self_enroll of this SchoolIdCoursesBody.

        Allows a student to enroll themselves in the course if set to true  # noqa: E501

        :param self_enroll: The self_enroll of this SchoolIdCoursesBody.  # noqa: E501
        :type: bool
        """
    ...
    def external_id(self):
        """Gets the external_id of this SchoolIdCoursesBody.  # noqa: E501

        An external id to reference the course  # noqa: E501

        :return: The external_id of this SchoolIdCoursesBody.  # noqa: E501
        :rtype: str
        """
    ...
    def external_id(self, external_id):
        """Sets the external_id of this SchoolIdCoursesBody.

        An external id to reference the course  # noqa: E501

        :param external_id: The external_id of this SchoolIdCoursesBody.  # noqa: E501
        :type: str
        """
    ...
    @property
    def trashed(self):
        """Gets the trashed of this SchoolIdCoursesBody.  # noqa: E501

        Defines if a course has been soft deleted  # noqa: E501

        :return: The trashed of this SchoolIdCoursesBody.  # noqa: E501
        :rtype: bool
        """
    ...
    def trashed(self, trashed):
        """Sets the trashed of this SchoolIdCoursesBody.

        Defines if a course has been soft deleted  # noqa: E501

        :param trashed: The trashed of this SchoolIdCoursesBody.  # noqa: E501
        :type: bool
        """
    ...
    @property
    def class_ids(self):
        """Gets the class_ids of this SchoolIdCoursesBody.  # noqa: E501

        An array of class ids that are part of the course  # noqa: E501

        :return: The class_ids of this SchoolIdCoursesBody.  # noqa: E501
        :rtype: list[int]
        """
    ...
    def class_ids(self, class_ids):
        """Sets the class_ids of this SchoolIdCoursesBody.

        An array of class ids that are part of the course  # noqa: E501

        :param class_ids: The class_ids of this SchoolIdCoursesBody.  # noqa: E501
        :type: list[int]
        """
    ...
    @property
    def study_ids(self):
        """Gets the study_ids of this SchoolIdCoursesBody.  # noqa: E501

        An array of study ids that the course belongs to  # noqa: E501

        :return: The study_ids of this SchoolIdCoursesBody.  # noqa: E501
        :rtype: list[int]
        """
    ...
    def study_ids(self, study_ids):
        """Sets the study_ids of this SchoolIdCoursesBody.

        An array of study ids that the course belongs to  # noqa: E501

        :param study_ids: The study_ids of this SchoolIdCoursesBody.  # noqa: E501
        :type: list[int]
        """
    ...
    @property
    def period_ids(self):
        """Gets the period_ids of this SchoolIdCoursesBody.  # noqa: E501

        An array of period ids that the course takes place in  # noqa: E501

        :return: The period_ids of this SchoolIdCoursesBody.  # noqa: E501
        :rtype: list[int]
        """
    ...
    def period_ids(self, period_ids):
        """Sets the period_ids of this SchoolIdCoursesBody.

        An array of period ids that the course takes place in  # noqa: E501

        :param period_ids: The period_ids of this SchoolIdCoursesBody.  # noqa: E501
        :type: list[int]
        """
    ...
    @property
    def learners(self):
        """Gets the learners of this SchoolIdCoursesBody.  # noqa: E501

        An array of user ids that will be in the course and have the learner role  # noqa: E501

        :return: The learners of this SchoolIdCoursesBody.  # noqa: E501
    ...
    def learners(self, learners):
        """Sets the learners of this SchoolIdCoursesBody.

        An array of user ids that will be in the course and have the learner role  # noqa: E501

        :param learners: The learners of this SchoolIdCoursesBody.  # noqa: E501
    ...
    def invigilators(self):
        """Gets the invigilators of this SchoolIdCoursesBody.  # noqa: E501

        An array of user ids that will be in the course that have the invigilator role  # noqa: E501

        :return: The invigilators of this SchoolIdCoursesBody.  # noqa: E501
    ...
    def invigilators(self, invigilators):
        """Sets the invigilators of this SchoolIdCoursesBody.

        An array of user ids that will be in the course that have the invigilator role  # noqa: E501

        :param invigilators: The invigilators of this SchoolIdCoursesBody.  # noqa: E501
    ...
    @property
    def reviewers(self):
        """Gets the reviewers of this SchoolIdCoursesBody.  # noqa: E501

        An array of user ids that will be in the course that have the reviewer role  # noqa: E501

        :return: The reviewers of this SchoolIdCoursesBody.  # noqa: E501
        :rtype: list[Apiv2schoolsschoolIdcoursesInvigilators]
        """
    ...
    def reviewers(self, reviewers):
        """Sets the reviewers of this SchoolIdCoursesBody.

        An array of user ids that will be in the course that have the reviewer role  # noqa: E501

        :param reviewers: The reviewers of this SchoolIdCoursesBody.  # noqa: E501
        :type: list[Apiv2schoolsschoolIdcoursesInvigilators]
        """
    ...
    def instructors(self):
        """Gets the instructors of this SchoolIdCoursesBody.  # noqa: E501

        An array of user ids that will be in the course that have the instructor role  # noqa: E501

        :return: The instructors of this SchoolIdCoursesBody.  # noqa: E501
        :rtype: list[Apiv2schoolsschoolIdcoursesInvigilators]
        """
    ...
    def instructors(self, instructors):
        """Sets the instructors of this SchoolIdCoursesBody.

        An array of user ids that will be in the course that have the instructor role  # noqa: E501

        :param instructors: The instructors of this SchoolIdCoursesBody.  # noqa: E501
        :type: list[Apiv2schoolsschoolIdcoursesInvigilators]
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(SchoolIdCoursesBody, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, SchoolIdCoursesBody):
            return False
