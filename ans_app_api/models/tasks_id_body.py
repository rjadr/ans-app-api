...
class TasksIdBody(object):
    ...
    def __init__(self, content=None, due_date=None, assignee_id=None, resolved=False):  # noqa: E501
        """TasksIdBody - a model defined in Swagger"""  # noqa: E501
        self._content = None
        self._due_date = None
    ...
    @property
    def content(self):
        """Gets the content of this TasksIdBody.  # noqa: E501

        The content of the comment which describes task  # noqa: E501

        :return: The content of this TasksIdBody.  # noqa: E501
        :rtype: str
        """
    ...
    def content(self, content):
        """Sets the content of this TasksIdBody.

        The content of the comment which describes task  # noqa: E501

        :param content: The content of this TasksIdBody.  # noqa: E501
        :type: str
        """
        if content is None:
    ...
    @property
    def due_date(self):
        """Gets the due_date of this TasksIdBody.  # noqa: E501

        The date on which the task is due  # noqa: E501

        :return: The due_date of this TasksIdBody.  # noqa: E501
        :rtype: str
        """
    ...
    def due_date(self, due_date):
        """Sets the due_date of this TasksIdBody.

        The date on which the task is due  # noqa: E501

        :param due_date: The due_date of this TasksIdBody.  # noqa: E501
        :type: str
        """
    ...
    def assignee_id(self):
        """Gets the assignee_id of this TasksIdBody.  # noqa: E501
        ...
        :return: The assignee_id of this TasksIdBody.  # noqa: E501
        :rtype: int
        """
    ...
    def assignee_id(self, assignee_id):
        """Sets the assignee_id of this TasksIdBody.

        Optionally you can provide the user id of the user show should be assigned to the task. After assigning, the user will be notified.  # noqa: E501

        :param assignee_id: The assignee_id of this TasksIdBody.  # noqa: E501
        :type: int
        """
    ...
    @property
    def resolved(self):
        """Gets the resolved of this TasksIdBody.  # noqa: E501

        Defines whether the task has been resolved  # noqa: E501

        :return: The resolved of this TasksIdBody.  # noqa: E501
        :rtype: bool
        """
    ...
    def resolved(self, resolved):
        """Sets the resolved of this TasksIdBody.

        Defines whether the task has been resolved  # noqa: E501

        :param resolved: The resolved of this TasksIdBody.  # noqa: E501
        :type: bool
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(TasksIdBody, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, TasksIdBody):
            return False
