...
class ResultsIdBody(object):
    ...
    def __init__(self, approved=None, trashed=False, status='new', external_id=None, user_id=None, group_id=None):  # noqa: E501
        """ResultsIdBody - a model defined in Swagger"""  # noqa: E501
        self._approved = None
        self._trashed = None
        self._status = None
    ...
    @property
    def approved(self):
        """Gets the approved of this ResultsIdBody.  # noqa: E501
        ...
        :return: The approved of this ResultsIdBody.  # noqa: E501
        :rtype: bool
        """
    ...
    def approved(self, approved):
        """Sets the approved of this ResultsIdBody.

        Determines whether a result is approved, disapproved or undetermined. True will approve the result, false will disapprove it and null will mark it as undetermined  # noqa: E501

        :param approved: The approved of this ResultsIdBody.  # noqa: E501
        :type: bool
        """
    ...
    @property
    def trashed(self):
        """Gets the trashed of this ResultsIdBody.  # noqa: E501

        Determines whether a result has been soft deleted  # noqa: E501

        :return: The trashed of this ResultsIdBody.  # noqa: E501
        :rtype: bool
        """
    ...
    def trashed(self, trashed):
        """Sets the trashed of this ResultsIdBody.

        Determines whether a result has been soft deleted  # noqa: E501

        :param trashed: The trashed of this ResultsIdBody.  # noqa: E501
        :type: bool
        """
    ...
    @property
    def status(self):
        """Gets the status of this ResultsIdBody.  # noqa: E501
        ...
        :return: The status of this ResultsIdBody.  # noqa: E501
        :rtype: str
        """
        return self._status
    ...
    def status(self, status):
        """Sets the status of this ResultsIdBody.

        Determines the status of a result. Update the status to 'submitted' after uploading the student files to enable grading for this result  # noqa: E501

        :param status: The status of this ResultsIdBody.  # noqa: E501
        :type: str
        """
    ...
    def external_id(self):
        """Gets the external_id of this ResultsIdBody.  # noqa: E501

        An external id to reference the result  # noqa: E501

        :return: The external_id of this ResultsIdBody.  # noqa: E501
        :rtype: str
        """
    ...
    def external_id(self, external_id):
        """Sets the external_id of this ResultsIdBody.

        An external id to reference the result  # noqa: E501

        :param external_id: The external_id of this ResultsIdBody.  # noqa: E501
        :type: str
        """
    ...
    @property
    def user_id(self):
        """Gets the user_id of this ResultsIdBody.  # noqa: E501
        ...
        :return: The user_id of this ResultsIdBody.  # noqa: E501
        :rtype: int
        """
    ...
    def user_id(self, user_id):
        """Sets the user_id of this ResultsIdBody.

        The id of the user, null if the result is for a group assignment. Can only be set on creation and cannot be changed on existing results  # noqa: E501

        :param user_id: The user_id of this ResultsIdBody.  # noqa: E501
        :type: int
        """
    ...
    @property
    def group_id(self):
        """Gets the group_id of this ResultsIdBody.  # noqa: E501
        ...
        :return: The group_id of this ResultsIdBody.  # noqa: E501
        :rtype: int
        """
    ...
    def group_id(self, group_id):
        """Sets the group_id of this ResultsIdBody.

        The id of the group, null if the result is for an individual assignment. Can only be set on creation and cannot be changed on existing results  # noqa: E501

        :param group_id: The group_id of this ResultsIdBody.  # noqa: E501
        :type: int
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(ResultsIdBody, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ResultsIdBody):
            return False
